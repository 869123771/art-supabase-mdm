...
人员/工作中心配置的所属部门复用生产部门树：新增时跟随左侧选中节点，选择人员后校准为其当前部门，也允许具有 `MdmPersonnelWorkCenter:Edit` 的用户改选。保存 RPC 在同一事务内更新人员所属部门和常用工作中心，并校验人员、部门、工作中心属于同一可写租户；该权限只扩展到人员的 `department_id`，不能修改人员档案的其他字段。
